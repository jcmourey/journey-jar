...
extension TVShow {
    @MainActor
    struct Mock {
        let noRecommendation = TVShow(id: UUID().uuidString, title: "Dexter", dateAdded: .now, dateModified: .now, recommendations: [], interest: .high, progress: .finished, tvdbInfo: .mock.dexter)
        let mock1 = TVShow(id: UUID().uuidString, title: "The Split", dateAdded: .now, dateModified: .now, recommendations: [.mock.mock0], interest: .absoluteMust, progress: .notStarted, tvdbInfo: .mock.theSplit)
        let mock2 = TVShow(id: UUID().uuidString, title: "HPI", dateAdded: .now, dateModified: .now, recommendations: [.mock.mock1], interest: .high, progress: .notStarted, tvdbInfo: .mock.hpi)
        let multipleRecommendations = TVShow(id: UUID().uuidString, title: "Star Trek: Picard", dateAdded: .now, dateModified: .now, recommendations: [.mock.mock2, .mock.mock3], interest: .high, progress: .finished, tvdbInfo: .mock.starTrekPicard)
    }
    static var mock: Mock { Mock() }
}
